export const normalizeEval = (evalScore: number, fen: string): number => {
...
export const onMessage = (
  data: string, 
  setEvalScore: React.Dispatch<React.SetStateAction<number>>, 
  setBestLine: React.Dispatch<React.SetStateAction<string>>, 
  fen: string, 
