...
function IconWinnerCrown({ size = 18, ...rest }: IconProps) {
  return (
...
function IconLoserFlag({ size = 18, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} viewBox={VB} aria-hidden {...rest}>
...
function IconBest({ size, ...rest }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
function IconBrilliant({ size, ...rest }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
function IconExcellent({ size, ...rest }: IconProps) {
  return (
...
function IconGood({ size, ...rest }: IconProps) {
  return (
...
function IconInaccuracy({ size, ...rest }: IconProps) {
  return (
...
function IconMistake({ size, ...rest }: IconProps) {
  return (
...
function IconMiss({ size, ...rest }: IconProps) {
  return (
...
function IconBlunder({ size, ...rest }: IconProps) {
  return (
 ...
 */
export function MoveCategoryBoardIcon({ categoryId, size }: {categoryId: string, size: number}) {
  const Icon = categoryId ? ICON_BY_CATEGORY[categoryId] : null;
  if (!Icon) return null;
  return <Icon size={size} />;
}

export function WinnerCrownBoardIcon({ size = 18 }: {size: number}) {
  return <IconWinnerCrown size={size} />;
}

export function LoserFlagBoardIcon({ size = 18 }: {size: number}) {
